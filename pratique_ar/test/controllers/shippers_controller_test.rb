...
class ShippersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create shipper" do
    assert_difference('Shipper.count') do
      post shippers_url, params: { shipper: { phone: @shipper.phone, shipper_name: @shipper.shipper_name } }
    end
  ...
  test "should update shipper" do
    patch shipper_url(@shipper), params: { shipper: { phone: @shipper.phone, shipper_name: @shipper.shipper_name } }
